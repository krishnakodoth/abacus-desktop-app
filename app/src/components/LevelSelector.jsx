...
function LevelSelector({ onLevelSelect, onExamSelect }) {
    ...
    <div className="level-selector">
      ...
      <div className="level-section">
        ...
        <div className="exam-level">
          <h4>Take a Timed Exam (50 Questions)</h4>
          <p className="exam-description">
            Test your skills with 50 questions. Timer starts when you begin. View all answers at the end.
          </p>
          <div className="custom-controls">
            <div className="custom-control">
